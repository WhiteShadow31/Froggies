...
{
    public class DebugDraw2DDetection : MonoBehaviour
    {
        ...
        {
            if (this.transform.TryGetComponent<Collider2D>(out Collider2D col))
            {
                ...
                // Draw
                DebugDraw2D.Collider2D(col, capacityColor);
            }
        }
    }
}
