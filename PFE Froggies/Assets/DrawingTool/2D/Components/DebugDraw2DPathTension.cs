...
{
    public class DebugDraw2DPathTension : MonoBehaviour
    {
        [Header("Paths")]
        ...
        private void OnDrawGizmos()
        {
            ...
            if (simplePath)
                DebugDraw2D.Path2D(childs, _pathColor, pathLoop);
            else
                DebugDraw2D.PathTension2D(childs, _tensionGradient, _minimalDistance, _maximalDistance, pathLoop);
        }
    }
}
